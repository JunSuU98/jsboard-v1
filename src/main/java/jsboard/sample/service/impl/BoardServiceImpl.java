 ...
 */
package jsboard.sample.service.impl;
...
public class BoardServiceImpl extends EgovAbstractServiceImpl implements BoardService {
	...
	public BoardVO selectBoard(BoardVO vo) throws Exception {
		BoardVO resultVO = boardDAO.selectSample(vo);
		if (resultVO == null)
	...
	public List<?> selectBoardList(BoardDefaultVO searchVO) throws Exception {
		return boardDAO.selectSampleList(searchVO);
	}
	...
	public int selectBoardListTotCnt(BoardDefaultVO searchVO) {
		return boardDAO.selectSampleListTotCnt(searchVO);
	}
