...
<%
  /**
  * @Class Name : jsboardRegister.jsp
  * @Description : jsboard Register 화면
...
<head>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_jsboard_selectList() {
           	document.detailForm.action = "<c:url value='/jsBoardList.do'/>";
           	document.detailForm.submit();
        }
        
        /* 글 삭제 function */
        function fn_jsboard_delete() {
           	document.detailForm.action = "<c:url value='/deleteJsboard.do'/>";
           	document.detailForm.submit();
        }
        
        /* 글 등록 function */
        function fn_jsboard_save() {
        	frm = document.detailForm;
        	if(!validateBoardVO(frm)){
                return;
            }else{
            	frm.action = "<c:url value="${registerFlag == 'create' ? '/addJsboard.do' : '/updateJsboard.do'}"/>";
                frm.submit();
            }
        }
    		...
    		<ul>
    			<li>
                    <span class="btn_blue_l">
                        <a href="javascript:fn_jsboard_selectList();"><spring:message code="button.list" /></a>
                        <img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
                    </span>
                </li>
    			<li>
                    <span class="btn_blue_l">
                        <a href="javascript:fn_jsboard_save();">
                            <c:if test="${registerFlag == 'create'}"><spring:message code="button.create" /></c:if>
                            <c:if test="${registerFlag == 'modify'}"><spring:message code="button.modify" /></c:if>
                        </a>
                        <img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
    			...
    			<c:if test="${registerFlag == 'modify'}">
                    <li>
                        <span class="btn_blue_l">
                            <a href="javascript:fn_jsboard_delete();"><spring:message code="button.delete" /></a>
                            <img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
                        </span>
                    </li>
    			</c:if>
